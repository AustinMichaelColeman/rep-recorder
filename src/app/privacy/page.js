  ...
  return (
    <div className="max-w-3x1 mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100">
        Privacy Policy for Rep Recorder
      </h1>

      <p className="mt-6 text-gray-800 dark:text-gray-200">
        At Rep Recorder, accessible from{" "}
        <a
        ...
        and recorded by Rep Recorder and how we use it.
      </p>
      ...
      <p className="mt-6 text-gray-800 dark:text-gray-200">
        ...
        shared and/or collect in Rep Recorder. This policy is not applicable to
      ...
      <p className="mt-6 text-gray-800 dark:text-gray-200">
        {`Rep Recorder follows a standard procedure of using log files. These
      ...
      <p className="mt-6 text-gray-800 dark:text-gray-200">
        {`Like any other website, Rep Recorder uses "cookies". These cookies are
      ...
      <p className="mt-6 text-gray-800 dark:text-gray-200">
        ...
        advertising partners of Rep Recorder.
      </p>
      ...
      <p className="mt-6 text-gray-800 dark:text-gray-200">
        Rep Recorder does not knowingly collect any Personal Identifiable
      ...
      <p className="mt-6 text-gray-800 dark:text-gray-200">
        ...
        not hesitate to contact us. See the contact information at{" "}
        <a
          className="text-green-700 dark:text-green-400 underline"
          href="https://www.austincoleman.dev/"
        >
          www.austincoleman.dev
        </a>
        .
      </p>
    </div>
